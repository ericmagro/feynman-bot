  ...
  "posts": [
    {
      ...
      "summary": "A one-sentence summary generated by Claude Haiku",
      "content": "Full post content..."
    }
  ],
  "used_wonders": ["recently", "used", "wonder", "types"],
  "used_topics": ["recently", "used", "topics"],
  "pending_puzzle_answer": "Answer to reveal tomorrow, if any"
}
```

Each post gets a real summary generated by Haiku, focusing on the core concept. The history is sent to Claude as context to prevent repetition and enable callbacks.
